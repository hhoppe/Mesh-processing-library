...
:: call mesh_to_pm.bat results/gaudipark.orig.m -fit_colors 1 >results/gaudipark.pm
call mesh_to_pm.bat results/gaudipark.orig.m -minqem -norfac 0. -colfac 1. -neptfac 1e5 >results/gaudipark.pm
