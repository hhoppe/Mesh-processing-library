...
# mesh_to_pm results/gaudipark.orig.m -fit_colors 1 >results/gaudipark.pm
mesh_to_pm results/gaudipark.orig.m -minqem -norfac 0. -colfac 1. -neptfac 1e5 >results/gaudipark.pm
