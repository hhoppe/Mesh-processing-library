...
G3dOGL -geom 800x820+150+10 -key DmDe -key O -key ,o----J    -st data/blob5.s3d data/blob5.orig.m | ^
G3dOGL -geom 800x820+970+10 -key DmDe -async -killeof -input -st data/blob5.s3d results/blob5.meshopt.simplified.m
