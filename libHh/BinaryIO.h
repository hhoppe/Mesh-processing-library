...
template <ranges::contiguous_range R> std::istream& read_binary_raw(std::istream& is, R&& range) {
...
template <ranges::contiguous_range R> std::ostream& write_binary_raw(std::ostream& os, const R& range) {
  const auto sp = std::span(range);
...
template <ranges::contiguous_range R> std::istream& read_binary_std(std::istream& is, R&& range) {
...
template <ranges::contiguous_range R> std::ostream& write_binary_std(std::ostream& os, const R& range) {
