...
class Vector4i {
 ...
 public:
  ...
  [[nodiscard]] friend Vector4i operator-(const Vector4i& l) { return Vector4i(0) - l; }
  ...
  [[nodiscard]] friend Vector4i operator+(const Vector4i& l, const Vector4i& r) { return _mm_add_epi32(l._r, r._r); }
  [[nodiscard]] friend Vector4i operator-(const Vector4i& l, const Vector4i& r) { return _mm_sub_epi32(l._r, r._r); }
  [[nodiscard]] friend Vector4i operator*(const Vector4i& l, const Vector4i& r) {
#if defined(HH_NO_SSE41)
  ...
  [[nodiscard]] friend Vector4i operator+(const Vector4i& v, int i) { return _mm_add_epi32(v._r, _mm_set1_epi32(i)); }
  [[nodiscard]] friend Vector4i operator-(const Vector4i& v, int i) { return _mm_sub_epi32(v._r, _mm_set1_epi32(i)); }
  [[nodiscard]] friend Vector4i operator*(const Vector4i& v, int i) {
#if defined(HH_NO_SSE41)
...
#if defined(HH_NO_SSE41)
  [[nodiscard]] friend Vector4i min(const Vector4i& l, const Vector4i& r) {
    return Vector4i(min(l[0], r[0]), min(l[1], r[1]), min(l[2], r[2]), min(l[3], r[3]));
  }
  [[nodiscard]] friend Vector4i max(const Vector4i& l, const Vector4i& r) {
    return Vector4i(max(l[0], r[0]), max(l[1], r[1]), max(l[2], r[2]), max(l[3], r[3]));
  }
#else
  [[nodiscard]] friend Vector4i min(const Vector4i& l, const Vector4i& r) { return _mm_min_epi32(l._r, r._r); }
  [[nodiscard]] friend Vector4i max(const Vector4i& l, const Vector4i& r) { return _mm_max_epi32(l._r, r._r); }
#endif
  [[nodiscard]] friend Vector4i operator&(const Vector4i& l, const Vector4i& r) { return _mm_and_si128(l._r, r._r); }
  [[nodiscard]] friend Vector4i operator|(const Vector4i& l, const Vector4i& r) { return _mm_or_si128(l._r, r._r); }
  [[nodiscard]] friend Vector4i operator^(const Vector4i& l, const Vector4i& r) { return _mm_xor_si128(l._r, r._r); }
  [[nodiscard]] friend Vector4i operator<<(const Vector4i& l, int n) { return _mm_slli_epi32(l._r, n); }
  [[nodiscard]] friend Vector4i operator>>(const Vector4i& l, int n) { return _mm_srai_epi32(l._r, n); }
#if defined(HH_NO_SSE41)
  [[nodiscard]] friend Vector4i abs(const Vector4i& l) { return Vector4i(abs(l[0]), abs(l[1]), abs(l[2]), abs(l[3])); }
#else
  [[nodiscard]] friend Vector4i abs(const Vector4i& l) { return _mm_abs_epi32(l._r); }
#endif
 ...
 private:
  ...
  void store_aligned(int* pDst) const { for_int(c, 4) pDst[c] = _c[c]; }
  [[nodiscard]] friend Vector4i operator+(const Vector4i& l, const Vector4i& r) {
    return Vector4i(l[0] + r[0], l[1] + r[1], l[2] + r[2], l[3] + r[3]);
  }
  [[nodiscard]] friend Vector4i operator-(const Vector4i& l, const Vector4i& r) {
  ...
  [[nodiscard]] friend Vector4i operator+(const Vector4i& v, int i) { return v + Vector4i(i); }
  [[nodiscard]] friend Vector4i operator-(const Vector4i& v, int i) { return v - Vector4i(i); }
  [[nodiscard]] friend Vector4i operator*(const Vector4i& v, int i) {
    return v * Vector4i(i);  // vmulq_n_s32(v._r, i)
  }
  ...
  [[nodiscard]] friend Vector4i operator<<(const Vector4i& l, int n) {
...
[[nodiscard]] inline Vector4i operator*(int i, const Vector4i& v) { return v * i; }
