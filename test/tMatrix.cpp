...
int main() {
    ...
    {
        Matrix<Vec2f> matrix1(3, 3); fill(matrix1, Vec2f(1.f, BIGFLOAT));
    ...
    }
    {
        ...
        // m[0] = m[2] = v1;
        // m[1] = m[3] = v2;
        m[0].assign(v1); m[2].assign(v1);
        m[1].assign(v2); m[3].assign(v2);
        SHOW(m);
        SHOW(v1);
        Array<float> v3a(v1);   // Array<float> v3a; v3a = v1;
        SHOW(v3a);
        Array<float> v3b; v3b = v1;
        SHOW(v3b);
        Array<float> v3(v1);
        SHOW(v3);
        Array<float> v4; v4 = m[0];
        SHOW(v4);
        SHOW(mat_mul(v3, m));
        v3 = mat_mul(v3, m);
        SHOW(v3);
        Array<float> v5(4); mat_mul(v1, m, v5); SHOW(v5);
        m[2][0] = 7;
        m[3][3] = 11;
        SHOW(m);
        SHOW(min(m));
...
#if 0                           // Matrix is a Grid, instanced in tGrid
namespace hh {
