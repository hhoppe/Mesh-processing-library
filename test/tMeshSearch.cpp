...
int main() {
    ...
    {
        GMesh mesh;
        Vertex v1 = mesh.create_vertex(); mesh.set_point(v1, Point(0.f, 0.f, 0.f));
        Vertex v2 = mesh.create_vertex(); mesh.set_point(v2, Point(10.f, 0.f, 0.f));
        Vertex v3 = mesh.create_vertex(); mesh.set_point(v3, Point(10.f, 10.f, 0.f));
        Vertex v4 = mesh.create_vertex(); mesh.set_point(v4, Point(0.f, 10.f, 0.f));
    ...
    }
    {
        ...
        for_int(y, n) for_int(x, n) {
            matv[y][x] = mesh.create_vertex(); mesh.set_point(matv[y][x], Point(x/(n-1.f), y/(n-1.f), 0.f));
        }
